...
namespace mylib
{
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////////
		// Client ON/OFF
		bool	Start(WCHAR* wszIP, int iPort, int iWorkerThreadCnt, bool bNagle);
...
#define MON_CLIENT_CONNECT_CNT		mylib::CLanClient::en_CONNECT_CNT
#define MON_CLIENT_ACCEPT_CNT		mylib::CLanClient::en_ACCEPT_CNT
